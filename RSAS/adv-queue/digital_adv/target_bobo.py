...
def evaluate(net, probe_path, gallery_path, adv_index, target_index, adv_id, target_id, res):
...
if __name__ == '__main__':
    ...
    res = queue.Queue()
    evaluate(net, adv_path, gallery_path, adv_index, target_index, adv_id, target_id, res)
